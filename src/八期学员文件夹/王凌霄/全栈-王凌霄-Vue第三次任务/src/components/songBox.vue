  ...
  <section>
    <songList>
        ...
        <template v-slot:songList>
            <ol>
                <li v-for="song in hotSong.tracks" :key="song.picUrl">
                {{ song.name }}
                </li>
            </ol>
        </template>
    ...
    <songList>
        <template v-slot:text>
            ...
            <br>
            <br>
            <span>{{ newSing.description }}</span>
        </template>
        <template v-slot:pic>
            <img :src='newSing.coverImgUrl' alt="">
        </template>
        <template v-slot:songList>
            <ol>
                <li v-for="song in newSing.tracks" :key="song.picUrl">
                {{ song.name }}
                </li>
            </ol>
        </template>
    ...
    <songList>
        ...
        <template v-slot:songList>
            <ol>
                <li v-for="song in originSong.tracks" :key="song.picUrl">
                {{ song.name }}
                </li>
            </ol>
        </template>
