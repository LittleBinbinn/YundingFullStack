    ...
    <AppFrame>
      ...
      <template #content>
        <div :class="comClass">
          ...
          <AppFrame>
            <template #title>
              <AppListHeader :list="newList"></AppListHeader>
            </template>
            <template #content>
              <AppListContent :list="newList"></AppListContent>
            </template>
          </AppFrame>
          <!-- <AppListHeader v-for="(item, index) in lists" :key="index" :list="item"></AppListHeader>
          <AppListContent v-for="(item, index) in lists" :key="index" :list="item"></AppListContent> -->

          <!-- 热歌榜 -->
          <AppFrame>
            <template #title>
              <AppListHeader :list="hotList"></AppListHeader>
            </template>
            <template #content>
              <AppListContent :list="hotList"></AppListContent>
            </template>
          </AppFrame>
          ...
          <AppFrame>
            <template #title>
              <AppListHeader :list="oriList"></AppListHeader>
            </template>
            <template #content>
              <AppListContent :list="oriList"></AppListContent>
            </template>
          </AppFrame>
...
import AppSinger from './components/AppSinger.vue'
import AppListHeader from './components/AppListHeader.vue'
import AppListContent from './components/AppListContent.vue'
  export default{
    name:'App',
    components:{
      AppFrame,
